      ...
      <div class="row g-xl-8">
        <div class="card card-flush">
          <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-menu-category">
              Add Category
            </button>
          </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                  <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                      ...
                      <th class="min-w-200px">Menu Category</th>
                      ...
                      <tr>
                        ...
                        <td class="text-start">
                          <div class="symbol symbol-50px">
                            <span class="symbol-label" style="background-image: url({{ asset('assets-admin/media/menus/'.$dt->category_image) }})"></span>
                          </div>
                        </td>
                        <td class="text-start">
                        ...
                        <td class="text-start">
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                              <a href="javascript:void(0);" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#edit-menu-category-{{ $dt->id }}"> Edit </a>
                            </div>
  
                            <div class="menu-item px-3">
                              <a href="{{ route('menu-category.destroy', $dt->id) }}" class="menu-link px-3" data-confirm-delete="true"> Delete </a>
                            </div>
                          </div>
                        </td>
                      </tr>
...
@include('admin.menu_category.create')
@foreach ($data as $dt)
@include('admin.menu_category.edit')
@endforeach
@endsection
